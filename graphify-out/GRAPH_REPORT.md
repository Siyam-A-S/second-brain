...
## Corpus Check
- 62 files · ~56,882 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1113 nodes · 2599 edges · 53 communities (45 shown, 8 thin omitted)
...
Cohesion: 0.07
Nodes (39): ChatWorkbenchProps, MarkdownBlock, MessageContent(), ResponseSection, slug(), splitResponseSections(), AppSettingsProvider, artifactFileName() (+31 more)
...
Cohesion: 0.30
Nodes (11): legacyTrackerToTicket(), normalizeOptionalDate(), normalizePriority(), normalizeStatus(), normalizeStringArray(), normalizeText(), nowIso(), trackerPriorities (+3 more)
...
Cohesion: 0.09
Nodes (24): ChatWorkbench(), DropTarget(), DropTargetProps, DropTone, toneColors, ProjectList(), ProjectListProps, SettingsPanel() (+16 more)
...
Cohesion: 0.08
Nodes (26): api, boardChannels, brainChannels, chatChannels, clipboardChannels, explorerChannels, fileChannels, graphBoardChannels (+18 more)
...
- **Why does `GraphifyController` connect `Community 25` to `Community 32`, `Demo Mockup Logic`, `Embedding Pipeline`, `Community 43`, `Community 48`, `Community 50`, `Community 52`, `Community 26`?**
