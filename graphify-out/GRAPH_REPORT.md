...
## Corpus Check
- 55 files · ~42,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 884 nodes · 1988 edges · 41 communities (36 shown, 5 thin omitted)
...
Cohesion: 0.11
Nodes (15): CandidateScore, deriveTopicTitle(), GraphRagService, validationBoost(), BoardChildNode, BoardTopologyNode, ExportBoardPlaintextInput, FetchFileSegmentsInput (+7 more)
...
Cohesion: 0.11
Nodes (18): GraphifyProvider, IngestAndRouteFragmentResult, BoardChannel, BrainChannel, brainChannels, ClipboardChannel, ExplorerChannel, FileChannel (+10 more)
...
Cohesion: 0.05
Nodes (43): AgentMethodConfig, agentPrompts, AiSettingsProvider, ChatAttemptOptions, ChatCompletionResponse, ChatMessage, errorText(), extractChatContent() (+35 more)
...
Cohesion: 0.15
Nodes (12): api, boardChannels, brainChannels, clipboardChannels, explorerChannels, fileChannels, graphBoardChannels, projectChannels (+4 more)
...
- **Why does `GraphifyController` connect `Community 25` to `GraphRAG Services`, `Community 32`, `Demo Mockup Logic`, `Community 40`, `Community 10`, `Embedding Pipeline`, `Hook Config`, `Community 26`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `ExplorerService` connect `Community 7` to `Embedding Pipeline`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `StorageService` connect `Community 37` to `Community 32`, `Markdown Storage`, `Community 38`, `Community 8`, `Community 10`, `Embedding Pipeline`?**
