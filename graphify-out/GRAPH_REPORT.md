...
## Corpus Check
- 55 files · ~27,766 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 604 nodes · 1093 edges · 32 communities (25 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aaacd3cc`
...
Cohesion: 0.07
Nodes (22): bufferFromDroppedValue(), errorMessage(), GraphifyController, GraphifyGraph, GraphifyLocalModelSettings, GraphifyProviderConfig, graphifyQuestion, looksComplete() (+14 more)

### Community 1 - "Electron Shell"
Cohesion: 0.12
Nodes (23): asRecord(), asString(), asStringArray(), buildDegreeMap(), countBy(), extractLinks(), extractNodes(), fallbackDate (+15 more)
...
Cohesion: 0.08
Nodes (24): AgentMethodConfig, agentPrompts, ChatCompletionResponse, ChatMessage, ExtractedJobMetadata, LlmService, normalizeDate(), normalizeGraphifyJobDraft() (+16 more)

### Community 5 - "Markdown Storage"
Cohesion: 0.06
Nodes (33): CachedEmbedding, EmbeddingService, fingerprintNode(), searchableText(), TransformersModule, CandidateScore, deriveTopicTitle(), GraphRagService (+25 more)
...
Cohesion: 0.09
Nodes (23): ClipboardList(), icons, DropTarget(), DropTargetProps, DropTone, toneColors, Sidebar(), SidebarProps (+15 more)
...
Cohesion: 0.06
Nodes (42): createDropPayload(), ElectronFile, createMainWindow(), createWidgetWindow(), isDev, loadRenderer(), preloadEntry, rendererEntry (+34 more)

### Community 12 - "Job Persistence"
Cohesion: 0.10
Nodes (20): ExportState, JobTrackerTable(), JobTrackerTableProps, LoadState, progressClass(), progressWidth(), statusOptions, JobTrackerService (+12 more)
...
Cohesion: 0.08
Nodes (21): BoardRenderer(), BoardRendererProps, BoardTab, boardTabs, formatDate(), GraphHtmlViewer(), TitleBar(), ExportState (+13 more)

## Knowledge Gaps
- **219 isolated node(s):** `PreToolUse`, `appId`, `productName`, `output`, `buildResources` (+214 more)
...
- **Why does `GraphifyController` connect `GraphRAG Services` to `Community 8`, `Embedding Pipeline`, `Job Table UI`, `Job Persistence`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `StorageService` connect `Markdown Storage` to `Embedding Pipeline`, `Job Persistence`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `JobTrackerRecord` connect `Job Persistence` to `GraphRAG Services`, `Job Table UI`, `Markdown Storage`, `Browser Fallback`, `Embedding Pipeline`?**
