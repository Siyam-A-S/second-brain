# Graph Report - second-brain  (2026-07-08)

## Corpus Check
- 76 files · ~83,671 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1462 nodes · 3485 edges · 63 communities (57 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0516af66`
...
Cohesion: 0.21
Nodes (7): asRecord(), asString(), linkEndpointId(), normalizeGraphLinks(), normalizeGraphNodes(), normalizeSourceReference(), GraphCardDefinitionInput
...
Cohesion: 0.07
Nodes (25): AccessTokenProvider, AiSettingsProvider, bufferFromDroppedValue(), chunkArray(), collapsibleTextExtensions, endpointHostLabel(), GraphifyGraph, GraphifyInvocation (+17 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (56): CreateToolArtifactInput, AccessTokenProvider, AppSettingsProvider, artifactChatConfirmation(), artifactFileName(), ArtifactIngestor, artifactMimeFromName(), artifactPlannerSystemPrompt() (+48 more)

### Community 5 - "Markdown Storage"
Cohesion: 0.13
Nodes (13): DropTarget(), ProjectList(), ProjectListProps, Sidebar(), SidebarProps, ThemeMode, TitleBar(), TitleBarProps (+5 more)
...
Cohesion: 0.05
Nodes (54): asRecord(), asString(), buildInlineGraphTraversalStdout(), citationFromNodeHit(), compact(), dedupeCitations(), errorMessage(), excerptTitle() (+46 more)
...
Cohesion: 0.13
Nodes (11): DropTargetProps, DropTone, toneColors, createDropPayload(), ElectronFile, DroppedFile, FilesDroppedPayload, WidgetMovePayload (+3 more)

### Community 11 - "Embedding Pipeline"
Cohesion: 0.05
Nodes (51): clipboardFilePathsFromText(), createMainWindow(), createProjectRuntime(), createWidgetWindow(), installZoomShortcuts(), isDev, loadRenderer(), preloadEntry (+43 more)
...
Cohesion: 0.17
Nodes (13): exists(), formatStorageBytes(), isEnoent(), nowIso(), ProjectService, ProjectState, safeProjectId(), CreateProjectInput (+5 more)
...
Cohesion: 0.08
Nodes (35): AgentMethodConfig, agentPrompts, AiSettingsProvider, ChatAttemptOptions, ChatCompletionChunk, ChatCompletionResponse, ChatMessage, errorText() (+27 more)
...
Cohesion: 0.11
Nodes (17): AccountSettings, AiMode, AppearanceSettings, BoardTopologyNode, ChatArtifactSource, ChatRole, GraphBoardNeighbor, GraphifyRuntimeSettings (+9 more)
...
Cohesion: 0.09
Nodes (23): AccountAuthService, asRecord(), normalizeStatus(), normalizeUsage(), StoredSession, stringValue(), SupabaseAuthResponse, firstReadableBuildInfoPath() (+15 more)
...
Cohesion: 0.20
Nodes (5): errorMessage(), paperComponentDirectoryNameForSource(), pdfPaperComponentScript(), researchDependencyStatusScript(), ResearchDependencyReport
...
- **Why does `GraphifyController` connect `Community 46` to `Community 0`, `Community 32`, `Demo Mockup Logic`, `Community 8`, `Embedding Pipeline`, `Community 50`, `Community 26`, `Community 59`, `Community 29`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `GraphifyContextService` connect `Community 8` to `Embedding Pipeline`, `Community 36`?**
