...
## Corpus Check
- 55 files · ~27,623 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 602 nodes · 1086 edges · 34 communities (27 shown, 7 thin omitted)
...
Cohesion: 0.06
Nodes (44): createDropPayload(), ElectronFile, createMainWindow(), createWidgetWindow(), isDev, loadRenderer(), preloadEntry, rendererEntry (+36 more)
...
Cohesion: 0.08
Nodes (22): AgentController, DraftFragment, inferContextHints(), inferTitle(), looksLikeJobDescription(), summarize(), CandidateScore, deriveTopicTitle() (+14 more)

### Community 33 - "Community 33"
Cohesion: 0.07
Nodes (22): BoardRenderer(), BoardRendererProps, BoardTab, boardTabs, formatDate(), GraphHtmlViewer(), TitleBar(), ExportState (+14 more)
...
- **Why does `GraphifyController` connect `GraphRAG Services` to `Community 32`, `Embedding Pipeline`, `Job Table UI`, `Job Persistence`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `StorageService` connect `Markdown Storage` to `Community 32`, `LLM Tool Runtime`, `Embedding Pipeline`, `Job Persistence`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `JobTrackerRecord` connect `Job Persistence` to `GraphRAG Services`, `Community 32`, `Job Table UI`, `Browser Fallback`, `Embedding Pipeline`?**
