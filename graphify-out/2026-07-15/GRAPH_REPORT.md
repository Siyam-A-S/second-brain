# Graph Report - second-brain  (2026-07-13)

## Corpus Check
- 78 files · ~85,439 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1483 nodes · 3538 edges · 74 communities (69 shown, 5 thin omitted)
...
Cohesion: 0.10
Nodes (20): AccessTokenProvider, AiSettingsProvider, bufferFromDroppedValue(), collapsibleTextExtensions, GraphifyGraph, GraphifyInvocation, GraphifyLinkRecord, GraphifyLocalModelSettings (+12 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (58): CreateToolArtifactInput, AccessTokenProvider, AppSettingsProvider, artifactChatConfirmation(), artifactFileName(), ArtifactIngestor, artifactMimeFromName(), artifactPlannerSystemPrompt() (+50 more)
...
Cohesion: 0.15
Nodes (6): errorMessage(), paperComponentDirectoryNameForSource(), parseArgs(), pdfPaperComponentScript(), researchDependencyStatusScript(), ResearchDependencyReport
...
Cohesion: 0.06
Nodes (43): clipboardFilePathsFromText(), createMainWindow(), createProjectRuntime(), createWidgetWindow(), installZoomShortcuts(), isDev, loadRenderer(), preloadEntry (+35 more)
...
Cohesion: 0.41
Nodes (3): nowIso(), ProjectService, ProjectRecord
...
Cohesion: 0.11
Nodes (22): AccessTokenProvider, AiSettingsProvider, ChatAttemptOptions, ChatCompletionChunk, ChatCompletionResponse, ChatMessage, extractChatContent(), extractChunkDelta() (+14 more)
...
Cohesion: 0.11
Nodes (17): AccountSettings, AiMode, AppearanceSettings, BoardTopologyNode, ChatArtifactSource, ChatRole, ClipboardIngestibleItemsResult, GraphifyRuntimeSettings (+9 more)
...
Cohesion: 0.12
Nodes (3): GraphifyController, looksComplete(), GraphDefinitionStatus
...
Cohesion: 0.14
Nodes (9): CandidateScore, deriveTopicTitle(), GraphRagService, validationBoost(), ExportBoardPlaintextInput, FetchFileSegmentsInput, IngestAndRouteFragmentInput, OrganizedBoardTopic (+1 more)
...
Cohesion: 0.29
Nodes (5): AgentMethodConfig, errorText(), LlmService, sanitizeErrorText(), shouldRetryWithFallback()

### Community 59 - "Community 59"
Cohesion: 0.24
Nodes (7): exists(), formatStorageBytes(), isEnoent(), ProjectState, safeProjectId(), ProjectSelectionInput, ProjectStorageUsage
...
Cohesion: 0.27
Nodes (9): formatAccountDate(), SettingsPanel(), SettingsPanelProps, statusLabel(), statusTone(), isProductionBuild(), presentError(), presentPossiblyDetailedError() (+1 more)
...
## Knowledge Gaps
- **367 isolated node(s):** `name`, `version`, `description`, `main`, `author` (+362 more)
...
- **Why does `GraphifyController` connect `Community 46` to `Community 0`, `Demo Mockup Logic`, `Community 68`, `Community 36`, `Community 58`, `Community 8`, `Embedding Pipeline`, `Community 26`, `Community 29`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `GraphifyContextService` connect `Community 36` to `Community 51`, `Embedding Pipeline`?**
