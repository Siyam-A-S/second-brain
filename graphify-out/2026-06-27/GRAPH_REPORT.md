...
## Corpus Check
- 62 files · ~57,531 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1120 nodes · 2608 edges · 52 communities (47 shown, 5 thin omitted)
...
Cohesion: 0.09
Nodes (30): AppSettingsProvider, artifactFileName(), ArtifactIngestor, artifactMimeFromName(), artifactTitleFromQuestion(), ChatService, ChatState, collectProxyAttachments() (+22 more)

### Community 5 - "Markdown Storage"
Cohesion: 0.05
Nodes (30): CachedEmbedding, EmbeddingService, fingerprintNode(), searchableText(), TransformersModule, CandidateScore, deriveTopicTitle(), GraphRagService (+22 more)
...
Cohesion: 0.40
Nodes (4): GraphifyProvider, IngestAndRouteFragmentResult, brainChannels, trackerChannels
...
Cohesion: 0.08
Nodes (30): browserAiSettings, browserApiFallback, browserAppSettings, browserDefinitionStatus, browserExplorerTree, browserPaper, browserPaperDetails, browserProjects (+22 more)
...
Cohesion: 0.15
Nodes (25): AiSettingsService, asRecord(), booleanSetting(), defaultGraphifySettings, normalizeAiMode(), normalizeApiKey(), normalizeEndpoint(), normalizeGraphifySettings() (+17 more)
...
Cohesion: 0.10
Nodes (20): BrainSearchResult, ChatArtifactSource, ResearchPaperComponentType, SearchBrainNodesInput, BoardChannel, BrainChannel, ChatChannel, ClipboardChannel (+12 more)
...
## Knowledge Gaps
- **272 isolated node(s):** `appId`, `productName`, `output`, `buildResources`, `files` (+267 more)
...
- **Why does `GraphifyController` connect `Community 25` to `Community 32`, `Demo Mockup Logic`, `Community 10`, `Embedding Pipeline`, `Community 43`, `Community 48`, `Community 52`, `Community 26`, `Community 29`?**
